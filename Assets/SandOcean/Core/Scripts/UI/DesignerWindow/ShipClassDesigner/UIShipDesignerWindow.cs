...
{
    public class UIShipDesignerWindow : MonoBehaviour
    {
            ...
            bool isInGameDesigner)
        {
                ...
                == true)
            {
                ...
                this.currentGameShipClass.CalculateCharacteristics(
                    contentData);
            ...
            {
                //Пересчитываем характеристики корабля
                this.currentWorkshopShipClass.CalculateCharacteristics(
                    contentData);
